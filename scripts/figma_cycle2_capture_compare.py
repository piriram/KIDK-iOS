...
SCREENS = [
    ...
    ScreenMap("07-city-creation", "7. 금액 가이드가 주어졌지만 직접 설정할 수 있는 화면.png", "mission-creation", 2.6),
    ScreenMap("08-city-building-detail", "8. 건물1 미션 화면.png", "city-building-detail", 2.2),
    ScreenMap("09-mission-in-progress", "9. 미션 진행 중 화면.png", "mission-in-progress", 2.0),
    ScreenMap("10-mission-completed", "10. 미션 진행 완료 화면.png", "mission-completed", 2.0),
]
...
def main():
    if len(sys.argv) < 2:
        print("Usage: figma_cycle2_capture_compare.py <iter-name>")
        sys.exit(1)

    iteration = sys.argv[1]
    base_dir = REPO_ROOT / "docs/figma-compare/cycle2" / iteration
